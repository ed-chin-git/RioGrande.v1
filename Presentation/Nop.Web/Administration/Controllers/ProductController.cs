// NopCommerce 3.5 Framework change :: ==EDC== Aug 1,2015 ::
// in Presentation/Nop.Admin/Controllers/
// added new method:: GenerateCustomSKU
 using System;
...
namespace Nop.Admin.Controllers
{
    public partial class ProductController : BaseAdminController
    {
        ...
        public String GenerateCustomSku(string PassedSKU, String PassedName)
        {
            ...
            // polarity
            if (PassedName.Contains("RWRP"))
            { CustomSku = (CustomSku + "R"); return CustomSku; }
            // Conductor
            if (PassedName.Contains("4"))
                { CustomSku = (CustomSku + "4"); return CustomSku; }
            if (PassedName.Contains("3"))
                { CustomSku = (CustomSku + "3"); return CustomSku; }
            // Pole Spacing
            if (PassedName.Contains("F type pole spacing"))
                { CustomSku = (CustomSku + "F"); return CustomSku; }
            if (PassedName.Contains("G type pole spacing"))
                { CustomSku = (CustomSku + "G"); return CustomSku; }
            if (PassedName.Contains("F Spacing"))
                { CustomSku = (CustomSku + "F"); return CustomSku; }
            if (PassedName.Contains("G Spacing"))
                { CustomSku = (CustomSku + "G"); return CustomSku; }
            // Hookup Leads
            if (PassedName.Contains("White / Black"))
                { CustomSku = (CustomSku + "WBPB"); return CustomSku; }
            if (PassedName.Contains("Yellow / Black"))
                {CustomSku = (CustomSku + "YBPB"); return CustomSku; }
            // Mounting Tabs
            if ((PassedName.ToLower()).Contains("mounting tabs")) 
                { CustomSku = (CustomSku + "MT"); return CustomSku; }
            // Rings
            if (PassedName.Contains("Black Ring Set"))
                { CustomSku = (CustomSku + "BRS"); return CustomSku; }
            if (PassedName.Contains("Creme Ring Set"))
                { CustomSku = (CustomSku + "CRS"); return CustomSku; }
            if (PassedName.Contains("Black Short Ring"))
            { CustomSku = (CustomSku + "BSR"); return CustomSku; }
            if (PassedName.Contains("Black Tall Ring"))
            { CustomSku = (CustomSku + "BTR"); return CustomSku; }
            if (PassedName.Contains("Creme Short Ring"))
            { CustomSku = (CustomSku + "CSR"); return CustomSku; }
            if (PassedName.Contains("Creme Tall Ring"))
            { CustomSku = (CustomSku + "CTR"); return CustomSku; }
            if (PassedName.Contains("Black P-90 Ring"))
            { CustomSku = (CustomSku + "B90"); return CustomSku; }
            if (PassedName.Contains("Creme P-90 Ring"))
            { CustomSku = (CustomSku + "C90"); return CustomSku; } 

            // COVERS p-90
            if (PassedName.Contains("Black Tall Cover"))
            { CustomSku = (CustomSku + "BTC"); return CustomSku; }
            if (PassedName.Contains("Black Short Cover"))
            { CustomSku = (CustomSku + "BSC"); return CustomSku; }
            if (PassedName.Contains("Creme Tall Cover"))
            { CustomSku = (CustomSku + "CTC"); return CustomSku; }
            if (PassedName.Contains("Creme Short Cover"))
            { CustomSku = (CustomSku + "CSC"); return CustomSku; }
            if (PassedName.Contains("Chrome Cover Tall"))
            { CustomSku = (CustomSku + "CHCT"); return CustomSku; }
            if (PassedName.Contains("Chrome Cover Short"))
            { CustomSku = (CustomSku + "CHCS"); return CustomSku; }


            // COLORS/COVERS          COVERS - Plastic
            if (PassedName.Contains("Parchment Cover"))
                {CustomSku = (CustomSku + "PC"); return CustomSku; }
            if (PassedName.Contains("Crème Cover"))
                {CustomSku = (CustomSku + "CC"); return CustomSku; }
            if (PassedName.Contains("Creme Cover"))
                {CustomSku = (CustomSku + "CC"); return CustomSku; }
            if (PassedName.Contains("Cream Cover"))
                { CustomSku = (CustomSku + "CC"); return CustomSku; }
            if (PassedName.Contains("Mint Green Cover"))
                {CustomSku = (CustomSku + "MGC"); return CustomSku; }
                                     //   TOPS
            if (PassedName.Contains("White Pearl Top"))
                {CustomSku = (CustomSku + "WPT"); return CustomSku; }
            if (PassedName.Contains("Crème Pearl Top"))
                {CustomSku = (CustomSku + "CPT"); return CustomSku; }
            if (PassedName.Contains("Creme Pearl Top"))
                {CustomSku = (CustomSku + "CPT"); return CustomSku; }
            if (PassedName.Contains("Black Pearl Top"))
                {CustomSku = (CustomSku + "BPT"); return CustomSku; }
            if (PassedName.Contains("White Gloss Top"))
                {CustomSku = (CustomSku + "WGT"); return CustomSku; }
            if (PassedName.Contains("Black Gloss Top"))
                {CustomSku = (CustomSku + "BGT"); return CustomSku; }
            if (PassedName.Contains("Crème Gloss Top"))
                {CustomSku = (CustomSku + "CGT"); return CustomSku; }
            if (PassedName.Contains("Creme Gloss Top"))
                {CustomSku = (CustomSku + "CGT"); return CustomSku; }
            if (PassedName.Contains("Mint Green Top"))
                {CustomSku = (CustomSku + "MGT"); return CustomSku; }
            if (PassedName.Contains("Tortoiseshell Top"))
                {CustomSku = (CustomSku + "TST"); return CustomSku; }
                                   //   SPARKLES
            if (PassedName.Contains("Blue Sparkle Top"))
                {CustomSku = (CustomSku + "BST"); return CustomSku; }
            if (PassedName.Contains("Gold Sparkle Top"))
                {CustomSku = (CustomSku + "GST"); return CustomSku; }
            if (PassedName.Contains("Green Sparkle Top"))
                {CustomSku = (CustomSku + "GRST"); return CustomSku; }
            if (PassedName.Contains("Purple Sparkle Top"))
                {CustomSku = (CustomSku + "PST"); return CustomSku; }
            if (PassedName.Contains("Red Sparkle Top"))
                {CustomSku = (CustomSku + "RST"); return CustomSku; }
            if (PassedName.Contains("Silver Sparkle Top"))
                {CustomSku = (CustomSku + "SST"); return CustomSku; }
 
                            //   COVERS - Metal
            if (PassedName.Contains("Closed Black Chrome Cover"))
                { CustomSku = (CustomSku + "CBCHC"); return CustomSku; }
            if (PassedName.Contains("Closed Chrome Cover"))
                { CustomSku = (CustomSku + "CCHC"); return CustomSku; }
            if (PassedName.Contains("Closed Gold Cover"))
                { CustomSku = (CustomSku + "CGC"); return CustomSku; }
            if (PassedName.Contains("Closed Nickel Cover"))
            { CustomSku = (CustomSku + "CNC"); return CustomSku; }
            if (PassedName.Contains("Closed Toasted Nickel Cover"))
                { CustomSku = (CustomSku + "CTNC"); return CustomSku; }

            if (PassedName.Contains("Chrome Cover w/Skull"))
                { CustomSku = (CustomSku + "CHCSK"); return CustomSku; }
            
            if (PassedName.Contains("Black Chrome Cover"))
                {CustomSku = (CustomSku + "BCHC"); return CustomSku; }
            if (PassedName.Contains("Chrome Cover"))
                {CustomSku = (CustomSku + "CHC"); return CustomSku; }
  
            if (PassedName.Contains("Chrome"))
                {CustomSku = (CustomSku + "CHC"); return CustomSku; }
            if (PassedName.Contains("Gold Metal Cover"))
                { CustomSku = (CustomSku + "GC"); return CustomSku; }
            if (PassedName.Contains("Gold Cover"))
                {CustomSku = (CustomSku + "GC"); return CustomSku; }
            if (PassedName.Contains("Gold"))
                {CustomSku = (CustomSku + "GC"); return CustomSku; }
            if (PassedName.Contains("Diamond Plate Cover"))
                {CustomSku = (CustomSku + "DPC"); return CustomSku; }
            if (PassedName.Contains("Diamond Faceplate"))
                {CustomSku = (CustomSku + "DPC"); return CustomSku; }
            if (PassedName.Contains("Diamond Plate"))
                { CustomSku = (CustomSku + "DPC"); return CustomSku; }
            if (PassedName.Contains("Diamondplate Cover"))
            { CustomSku = (CustomSku + "DPC"); return CustomSku; }
            if (PassedName.Contains("Diamond Faceplate"))
            { CustomSku = (CustomSku + "DPC"); return CustomSku; }
            if (PassedName.Contains("Diamondplate"))
            { CustomSku = (CustomSku + "DPC"); return CustomSku; }


            if (PassedName.Contains("Raw Finish Faceplates with Skull"))
            { CustomSku = (CustomSku + "RFFPSK"); return CustomSku; }
            if (PassedName.Contains("Nickel Faceplates with Skull"))
            { CustomSku = (CustomSku + "NFPSK"); return CustomSku; }
            if (PassedName.Contains("Raw Finish Faceplate with Skull"))
            { CustomSku = (CustomSku + "RFFPSK"); return CustomSku; }
            if (PassedName.Contains("Nickel Faceplate with Skull"))
            { CustomSku = (CustomSku + "NFPSK"); return CustomSku; }
            if (PassedName.Contains("Toasted Nickel Cover with Skull"))
            { CustomSku = (CustomSku + "TNCSK"); return CustomSku; }
            if (PassedName.Contains("Toasted Nickel Covers with Skulls"))
            { CustomSku = (CustomSku + "TNCSK"); return CustomSku; }
            if (PassedName.Contains("Nickel Covers with Skulls"))
            { CustomSku = (CustomSku + "NCSK"); return CustomSku; }
            if (PassedName.Contains("Nickel Cover with Skull"))
            { CustomSku = (CustomSku + "NCSK"); return CustomSku; }
            
            
            
            if (PassedName.Contains("Raw Finish Faceplates w/Skull"))
                {CustomSku = (CustomSku + "RFFPSK"); return CustomSku; }
            if (PassedName.Contains("Nickel Faceplates w/Skull"))
                { CustomSku = (CustomSku + "NFPSK"); return CustomSku; }
            if (PassedName.Contains("Raw Finish Faceplate w/Skull"))
                { CustomSku = (CustomSku + "RFFPSK"); return CustomSku; }
            if (PassedName.Contains("Nickel Faceplate w/Skull"))
                { CustomSku = (CustomSku + "NFPSK"); return CustomSku; }
            if (PassedName.Contains("Toasted Nickel Cover w/Skull"))
                { CustomSku = (CustomSku + "TNCSK"); return CustomSku; }
            if (PassedName.Contains("Nickel Cover w/Skull"))
                { CustomSku = (CustomSku + "NCSK"); return CustomSku; }

            
            
            
            if (PassedName.Contains("Raw Finish Faceplate"))
                {CustomSku = (CustomSku + "RFFP"); return CustomSku; }
            if (PassedName.Contains("Nickel Faceplate"))
                {CustomSku = (CustomSku + "NFP"); return CustomSku; }
            if (PassedName.Contains("Toasted Nickel Cover"))
                {CustomSku = (CustomSku + "TNC"); return CustomSku; }
            if (PassedName.Contains("Toasted Nickel"))
                {CustomSku = (CustomSku + "TNC"); return CustomSku; }
            if (PassedName.Contains("Nickel Metal Cover"))
                {CustomSku = (CustomSku + "NC"); return CustomSku; }
            if (PassedName.Contains("Nickel Cover"))
                {CustomSku = (CustomSku + "NC"); return CustomSku; }
            if (PassedName.Contains("Nickel"))
                {CustomSku = (CustomSku + "NC"); return CustomSku; }
    
                                        // ZEBRAs
            if (PassedName.Contains("Reverse White Zebra"))
                { CustomSku = (CustomSku + "RWZ"); return CustomSku; }
            if (PassedName.Contains("Reverse Zebra"))
                { CustomSku = (CustomSku + "RZ"); return CustomSku; }
            if (PassedName.Contains("White Zebra"))
                { CustomSku = (CustomSku + "WZ"); return CustomSku; }
            if (PassedName.Contains("Zebra"))
                { CustomSku = (CustomSku + "Z"); return CustomSku; }

                                    // BASIC COLORS   THIS HAS TO BE CHECKED LAST !!!!!
            if (PassedName.Contains("Matte Black Top"))
                { CustomSku = (CustomSku + "MBT"); return CustomSku; }
            if (PassedName.Contains("Matte Black Cover"))
                { CustomSku = (CustomSku + "MBC"); return CustomSku; }
            if (PassedName.Contains("Matte Black"))
                { CustomSku = (CustomSku + "MB"); return CustomSku; }
            if (PassedName.Contains("Black Cover"))
                { CustomSku = (CustomSku + "BC"); return CustomSku; }
            if (PassedName.Contains("Aged White Cover"))
                { CustomSku = (CustomSku + "AWC"); return CustomSku; }
            if (PassedName.Contains("White Cover"))
                { CustomSku = (CustomSku + "WC"); return CustomSku; }
            if (PassedName.Contains("Black"))
        ...
        public ActionResult GenerateAllAttributeCombinations(int productId)
        {
            ...
            foreach (var attributesXml in allAttributesXml)
            {
                ...
                int CustomNotifyAdminForQuantityBelow = 1;
                var CustomSku = product.Sku;
                foreach (var  CurrentAttributeCombination in AttributeCombinationList)   // Read thru attributes that make up this combination
                {    
                    // Generate the Custom SKU
                    CustomSku = GenerateCustomSku(CustomSku, CurrentAttributeCombination.Name);
                    // Deal with Dotted Lines
                    if (CurrentAttributeCombination.Name.Contains("----------------------"))
                        { CustomAllowOutOfStock = false; CustomStockQuantity = -1; CustomNotifyAdminForQuantityBelow = -2; }
                }
                //-------------------------------------------------------------------------------------------------------------------
                ...
                var combination = new ProductAttributeCombination
                {
                    ProductId = product.Id,
                    AttributesXml = attributesXml,
                    StockQuantity = CustomStockQuantity,
                    AllowOutOfStockOrders = CustomAllowOutOfStock,
                    Sku = CustomSku,
                    ManufacturerPartNumber = null,
                    Gtin = null,
                    OverriddenPrice = null,
                    NotifyAdminForQuantityBelow = CustomNotifyAdminForQuantityBelow
                };
                _productAttributeService.InsertProductAttributeCombination(combination);
            }
